  ...
  return (
    <>
      <button
        ...
        className="rounded-lg border border-zinc-300 px-5 py-3 text-center font-semibold transition hover:border-zinc-950"
      >
        Modifier
      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-zinc-900">Modifier le projet</h2>
              <button
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-zinc-700 mb-1">Lien GitHub *</label>
                <input
                  name="githubUrl"
              ...
              <div>
                <label className="block text-sm font-medium text-zinc-700 mb-1">Lien démo</label>
                <input
                  name="demoUrl"
                  value={form.demoUrl}
                  onChange={handleChange}
              ...
              <div>
                <label className="block text-sm font-medium text-zinc-700 mb-1">Promotion</label>
                <select
                  name="promotionId"
              ...
              <div>
                <label className="block text-sm font-medium text-zinc-700 mb-1">Projet Ada</label>
                <select
                  name="adaProjectId"
